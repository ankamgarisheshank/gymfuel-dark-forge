...
const Hero: React.FC = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen relative flex flex-col items-center justify-center px-6 md:px-12 pt-20 pb-16"
    >
      ...
      <div className="container mx-auto text-center relative z-10 animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-white/80 max-w-2xl mx-auto mb-6"> {/* Reduced mb-10 to mb-6 */}
          Transform your physique with our scientifically backed nutrition and training resources
        </p>

        {/* Arrow placed above the button */}
        <div className="mb-8 animate-bounce"> {/* Added mb-8 for spacing below arrow */}
          <a href="#ticker" className="text-white/60 hover:text-white inline-block">
            <svg 
              width="24" 
              height="24" 
              viewBox="0 0 24 24" 
